...
class Apitizers extends StatefulWidget {
  List<Food> foods;
  int cId;
  String name;

 Apitizers({this.foods, this.name, this.cId});
  @override
  _ApitizersState createState() => _ApitizersState();
}

class _ApitizersState extends State<Apitizers> {
  String phoneNumber;
   ...
   Widget build(BuildContext context) {
    ...
    return  Wrap(
                          children: List.generate(widget.foods.length, (index) {
                              return widget.name=="appetizers"? Container(
                            //color: Colors.yellow,
