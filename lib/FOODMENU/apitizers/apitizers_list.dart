...
class ApitizersList extends StatefulWidget {
  @override
  _ApitizersListState createState() => _ApitizersListState();
}

class _ApitizersListState extends State<ApitizersList> {
      void initState() {
        ...
        children: <Widget>[
          Center(
            child: Container( color: Colors.white,
              ...
              child: Text("APPETIZERS",style: TextStyle(fontSize: 16, color: Colors.black,fontWeight: FontWeight.bold,fontFamily: 'Abel',)),
              ),
          ),
          Container(
            color: Colors.white,
