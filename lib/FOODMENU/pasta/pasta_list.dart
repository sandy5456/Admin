...
class PastaList extends StatefulWidget {
  var productId;
  @override
  _PastaListState createState() => _PastaListState();
}

class _PastaListState extends State<PastaList> {
    void initState() {
        ...
        children: <Widget>[
          Center(
            child: Container( color: Colors.white,
              ...
              child: Text("PASTA",style: TextStyle(fontSize: 16, color: Colors.black,fontWeight: FontWeight.bold,fontFamily: 'Abel',)),
              ),
          ),
          Container(
            color: Colors.white,
