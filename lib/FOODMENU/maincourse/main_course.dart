...
class ManCourse extends StatefulWidget {
  List<Food> foods;
  int cId;
  String name;

  ManCourse({this.foods, this.name, this.cId});
  @override
  _ManCourseState createState() => _ManCourseState();
}

class _ManCourseState extends State<ManCourse> {
  String phoneNumber;
   ...
   Widget build(BuildContext context) {
    ...
    return  Wrap(
                          children: List.generate(widget.foods.length, (index) {
                              return widget.name=="main course"? Container(
                            //color: Colors.yellow,
