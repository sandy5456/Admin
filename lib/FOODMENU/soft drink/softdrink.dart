...
class SoftDrink extends StatefulWidget {
  List<Food> foods;
  int cId;
  String name;

  SoftDrink({this.foods, this.name, this.cId});
  @override
  _SoftDrinkState createState() => _SoftDrinkState();
}

class _SoftDrinkState extends State<SoftDrink> {
  String phoneNumber;
   ...
   Widget build(BuildContext context) {
    ...
    return  Wrap(
                          children: List.generate(widget.foods.length, (index) {
                              return widget.name=="soft drink"? Container(
                            //color: Colors.yellow,
