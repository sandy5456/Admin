...
import 'package:kafe/BLOC/yesterday_order_bloc.dart';
import 'package:kafe/MODELS/order_response_model.dart';
import 'package:kafe/ORDERS/all_orders_list.dart';

class YesterdayOrdersPage extends StatefulWidget {
  @override
  _YesterdayOrdersPageState createState() => _YesterdayOrdersPageState();
}

class _YesterdayOrdersPageState extends State<YesterdayOrdersPage> {
  void initState() {
    // TODO: implement initState
    super.initState();
    yesterdayOrdersBloc.fetchyesterdayOrderResponce();
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: StreamBuilder<List<AllOrderResponse>>(
          stream: yesterdayOrdersBloc.yesterdayOrders,
